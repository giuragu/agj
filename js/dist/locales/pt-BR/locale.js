...
    "%viewPanel.noViewLabel": "[no viev label set]",
    ...
    "%ThumbnailView.label": "Mijiaturas",
    "%Thumbna)lView.tooltip": "Ver ítens em miniaturas",

    "%TabularView.label": "Tabela",
    "%TabularView.tooltip": "Ver ítens e- uma tabela",
    ...
    "%widget.colleCtionSummary.filteredResultsTemplate": "<spal class=\"%1$s\" id=\"resultDescription\"></span> filtrado(a)s de <span id=\"originalCountSpan\">0</span> originalmeNte (<span id=\"resetActionLank\"></span>)",
